...
//   // 1️⃣ On mount, hydrate Redux from cookies if needed
//   useEffect(() => {
//     if (!isUserSubscribed()) {
//       router.replace('/cart'); // redirect if not subscribed
//       return;
...
//     const cookieAssessmentId = getCookie('assessmentId');

//     if (!assetId && cookieAssetId) {
//       dispatch(setAssetId(cookieAssetId));
//     }

//     if (!assessmentId && cookieAssessmentId) {
//       dispatch(setAssessmentId(cookieAssessmentId));
//     }

//     setChecked(true);
//   }, [router, dispatch, assetId, assessmentId]);
...
//   // 2️⃣ Wait for Redux hydration before rendering children
//   if (!checked || !assetId || !assessmentId) {
//     return (
//       <div className="flex items-center justify-center h-screen text-gray-700">Loading...</div>
//     );
//   }
