...
// =========================
// =========================
// //path /dynamicApps/[app]/questions/[qusetionnumbers]
// 'use client';
// import React, { useState, useEffect, useMemo } from 'react';
// import Image from 'next/image';
// import { useParams, useRouter, usePathname } from 'next/navigation';
...
//     //   {/* Question Content */}
//     //   <div className="flex-1 max-w-xl w-full pl-6">
//     //     {/* Question Content */}
...
//   <div className="flex flex-col justify-between lg:flex-row w-full  lg:h-[100vh] overflow-hidden bg-red-600">
//     {/* 1. Question Content - width 60% */}
//     <div className="flex-1  bg-green-400 flex flex-col justify-center px-6  overflow-y-auto">
...
//         <p className="text-base md:text-xl lg:text-2xl text-gray-700 mb-8">
//           {question.Question}
//         </p>

//         {/* Options */}
//         <div className="flex items-center gap-4 md:gap-6 flex-wrap mb-10">
//           {question.Options.map((opt: number) => (
...
//                 onChange={() => handleOptionSelect(opt)}
//               />
//               <div className={`w-12 h-12 flex items-center justify-center rounded-full border-2 font-semibold text-lg transition-all ${
//                 selectedOption === opt ? 'bg-[#7F0000] border-[#7F0000] text-white' : 'bg-white border-gray-300 text-gray-600'
//               }`}>
//                 {opt}
//               </div>
//             </label>
...
//           onClick={handleNext}
//           disabled={selectedOption === null || isSubmitting}
//           className={`w-full max-w-md py-4 text-lg font-semibold transition-all ${
//             selectedOption === null || isSubmitting ? 'bg-gray-300 text-gray-500' : 'bg-[#7F0000] text-white'
//           }`}
//         >
//           {currentQuestionIndex < questions.length - 1 ? 'Next' : 'Finish'}
//         </button>
...
//     {/* 2. Illustration - width 40% and height 100% of parent */}
//     <div className=" bg-green-600 max-w-[546px] w-full flex  justify-end items-end overflow-hidden h-full ">
//       <div className="relative h-full w-full flex bg-yellow-600 justify-end items-end ">
//         <Image
//           src={question.CategoryImage || '/inclusion/qusetionsScreenBg.png'}
//           alt="Question Illustration"
//           fill
//           className="h-full w-fit object-contain object-right-bottom" // Force height to 100% and auto-width
//           priority
//         />
//       </div>
//     </div>
...
export default function QuestionPage() {
  ...
  return (
    <div className="flex flex-col justify-between lg:flex-row w-full h-full lg:h-[100vh] overflow-hidden ">
      {/* 1. Question Content - width 60% */}
      <div className="flex-1  flex flex-col justify-center px-6  overflow-y-auto">
        <div className="max-w-2xl w-full mx-auto lg:mx-0">
          ...
          <p className="text-base md:text-xl lg:text-2xl text-gray-700 mb-8">{question.Question}</p>
          ...
          <div className="flex items-center gap-4 md:gap-6 flex-wrap mb-10">
            {question.Options.map((opt: number) => (
              <label key={opt} className="cursor-pointer">
                ...
                />
                <div
                  className={`w-12 h-12 flex items-center justify-center rounded-full border-2 font-semibold text-lg transition-all ${
                    selectedOption === opt
      ...
      {/* 2. Illustration - width 40% and height 100% of parent */}
      <div className="hidden  max-w-[546px] w-full lg:flex  justify-end items-end overflow-hidden h-full ">
        <div className="relative h-full w-full flex  justify-end items-end ">
          <Image
            src={question.CategoryImage || '/inclusion/qusetionsScreenBg.png'}
            alt="Question Illustration"
            fill
            className="h-full w-fit object-contain object-right-bottom 2xl:object-center"
            priority
          />
        </div>
      </div>
