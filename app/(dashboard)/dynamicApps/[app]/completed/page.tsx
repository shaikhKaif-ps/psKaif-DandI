...
// ========================
// ========================
// app/(dashboard)/dynamicApps/[app]/completed/page.tsx
// 'use client';
...
// import { RootState } from '@/redux/store';
// import { useGetResultByAssessmentIdQuery } from '@/redux/slices/result/resultSlice';
// import { useGetAssessmentAdviceQuery } from '@/redux/slices/assesment/assesmentSlice'; // Import new hook
// import { setResultData } from '@/redux/slices/global/globalSlice';
...
//   } = useGetAssessmentAdviceQuery(assessmentId || '', { skip: !assessmentId });
...
//   if (resultLoading || adviceLoading) {
//     return <div className="text-center mt-10">Loading assessment details...</div>;
//   }

//   if (resultError || adviceError) {
//     return (
//       <div className="text-red-600 text-center mt-10">Please Wait Your Result is Generating</div>
//     );
//   }
...
//             }}
//             onClick={() => setActiveTab(tab.id)}
//             className={`relative z-10 rounded-full px-4 py-2 text-sm md:text-base font-medium transition-colors ${
//               activeTab === tab.id ? 'text-white' : 'text-gray-600'
//             }`}
//           >
//             {tab.label}
...
//       {/* Advice Tab */}
//       {activeTab === 'advice' && <Advice categories={categoryAdvice} />}
//     </div>
//   );
// }
// ================================
...
export default function CompletedPage() {
  ...
  // Show full loading only if both are loading
  if (resultLoading && adviceLoading) {
    return <div className="text-center mt-10">Loading assessment details...</div>;
  }
